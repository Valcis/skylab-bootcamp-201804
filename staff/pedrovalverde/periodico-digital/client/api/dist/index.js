...
var api = {
    ...
    registerUser: function registerUser(name, surname, email, username, password, birthdate, gender, address, permission) {
        ...
        return Promise.resolve().then(function () {
            ...
            if (typeof birthdate !== 'undefined' && !(typeof birthdate === 'undefined' ? 'undefined' : _typeof(birthdate)) !== 'string' && !DATE_REGEX.test(birthdate)) throw Error('user birthdate is not a date');
